                                ...
                                <div class="col-lg-6">
                                    <div class="p-lg-5 p-4">
                                        <div>
                                            ...
                                            <p class="text-muted">Acceder al sistema</p>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            <form action="" method="post" id="login_form">
                                                ...
                                                <div class="mb-3">
                                                    <div class="float-end">
                                                        <a href="auth-pass-reset-cover.html" class="text-muted">Olvido contraseña?</a>
                                                    </div>
                                                    <label class="form-label" for="usu_pass">Contraseña</label>
                                                    <div class="position-relative auth-pass-inputgroup mb-3">
                                                        <input type="password" class="form-control pe-5" name="usu_pass"  placeholder="Ingrese contraseña" id="usu_pass">
